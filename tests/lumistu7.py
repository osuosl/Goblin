...
class Lumistu7(unittest.TestCase):
    def setUp(self):
    ...
    def test_lumistu7(self):
        ...
        driver.find_element_by_id("username").send_keys("lumistu7")
        driver.find_element_by_id("password").clear()
        driver.find_element_by_id("password").send_keys("Tolerated43Each")
