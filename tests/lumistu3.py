...
class Lumistu3(unittest.TestCase):
    def setUp(self):
    ...
    def test_lumistu3(self):
        ...
        driver.find_element_by_id("username").send_keys("lumistu3")
        driver.find_element_by_id("password").clear()
        driver.find_element_by_id("password").send_keys("Rambling70Hogsheads")
        ...
        # Warning: verifyTextPresent may require manual changes
        try: self.assertRegexpMatches(driver.find_element_by_css_selector("BODY").text, r"^[\s\S]*lumistu3@[\s\S]*$")
        except AssertionError as e: self.verificationErrors.append(str(e))
        driver.find_element_by_id("continue_btn").click()
        # Warning: verifyTextPresent may require manual changes
